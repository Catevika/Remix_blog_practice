  ...
  return (
    <Form method="post" key={data.post?.slug ?? 'new'}>
      ...
      <p>
        ...
        <textarea name="markdown" id="markdown" rows={15} className={`${inputClassName} font-mono`} defaultValue={data.post?.markdown}></textarea>
      </p>
      ...
      <div className="flex justify-end gap-4">
        ...
        <button type="submit" name='intent' value={isNewPost ? 'create' : 'update'} className="rounded bg-blue-500 py-2 px-4 text-white hover:bg-blue-600 focus:bg-blue-400 disabled:bg-blue-300 " disabled={isCreating || isUpdating}>
